...
class ModifiedStableDiffusionPipeline(StableDiffusionPipeline):
    ...
    def _new_encode_prompt(self, prompt, device, num_images_per_prompt, do_classifier_free_guidance, negative_prompt, prompt_ids=None, prompt_embeddings=None):
        r"""
    ...
    def __call__(
        ...
        text_embeddings = self._new_encode_prompt(
            prompt, device, num_images_per_prompt, do_classifier_free_guidance, negative_prompt, prompt_ids, prompt_embeddings
        )
